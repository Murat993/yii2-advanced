    ...
    <div class="mobile__menu-wrap">
        <nav class="mobile__menu-nav">
            <ul class="mobile__list">
                <li class="mobile__item"><a href="#" class="mobile__link mobile__link-active">Заказ еды</a></li>
                <li class="mobile__item"><a href="#" class="mobile__link">Продукты и магазины</a></li>
                <li class="mobile__item"><a href="#" class="mobile__link">Акции</a></li>
            </ul>
            <div class="mobile__city">Ваш город: <a href="/city">Караганда</a></div>
        </nav>
        <a href="tel:77762502525" class="mobile__phone">+7 776 250-25-25</a>
    </div>
    <div class="mobile__cart">
        <a href="#" class="mobile__cart-link">Перейти в корзину</a>
        <div class="mobile__cart-amount">2</div>
    </div>
